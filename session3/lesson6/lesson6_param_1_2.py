...
# $ pytest -v -s lesson6_param_1_2.py
# ======================= test session starts =======================
...
# collected 4 items
#
# lesson6_param_1_2.py::TestLogin::test_guest_should_see_login_link[ru]
# start browser for test..
# PASSED
# quit browser..
#
# lesson6_param_1_2.py::TestLogin::test_guest_should_see_login_link[en-gb]
# start browser for test..
# PASSED
# quit browser..
#
# lesson6_param_1_2.py::TestLogin::test_guest_should_see_navbar_element[ru]
# start browser for test..
# !!! test_guest_should_see_navbar_element: ru!!!
# PASSED
# quit browser..
#
# lesson6_param_1_2.py::TestLogin::test_guest_should_see_navbar_element[en-gb]
# start browser for test..
