...
# svitlana@svitlana-HP-ProBook-455-G1:~/PyTest/environments/selenium_course/session3$ python3 lesson2_step9!_ПоискПодстроки_СостСообщОбОшибке.py
# if test passed - message appears: "All tests passed!"
# if test failed: AssertionError: expected 'sooome' to be substring of 'some_text'
...
if __name__ == "__main__":
    test_substring('some_text',  'sooome')
...
#     sub=substring
#     index=full.find(sub)
#     assert index!=-1,f"expected '{sub}' to be substring of '{full}'"
