...
Давайте создадим файл test_abs_project_1.py и напишем в нём следующий код:
...
$ python test_abs_project_2.py

Traceback (most recent call last):
  File "test_abs_project_1.py", line 9, in <module>
    test_abs2()
  File "test_abs_project_1.py", line 5, in test_abs2
    assert abs(-42) == -42, "Should be absolute value of a number"
