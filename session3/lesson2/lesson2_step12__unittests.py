...
# svitlana@svitlana-HP-ProBook-455-G1:~/PyTest/environments/selenium_course/session3/lesson2$ python3 lesson2_step12__unittests.py
...
# ----------------------------------------------------------------------
# Traceback (most recent call last):
#   File "lesson2_step12__unittests.py", line 72, in test_abs2
#     self.assertEqual(abs(-42), -42, "(test_abs2): Should be absolute value of a number")
# AssertionError: 42 != -42 : (test_abs2): Should be absolute value of a number
#
# ----------------------------------------------------------------------
