...
-- если мы не передали никакого аргумента в команду,
   а написали просто pytest, тест-раннер начнёт поиск в текущей директории
-- как аргумент можно передать
    a) файл,
    b) путь к директории или
    c) любую комбинацию директорий и файлов, например:
        a) pytest scripts/selenium_scripts
           # найти все тесты в директории scripts/selenium_scripts
        b) pytest test_user_interface.py
           # найти и выполнить все тесты в файле
        c) pytest scripts/drafts.py::test_register_new_user_parametrized
...
Подробности: https://docs.pytest.org/en/stable/goodpractices.html#conventions-for-python-test-discovery
"""
