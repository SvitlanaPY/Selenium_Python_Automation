...
# $ pytest -v -s s3_lesson5_marks_Skipped.py
# ======================== test session starts ==========================
...
# collected 4 items
#
# s3_lesson5_marks_Skipped.py::TestMainPage1::test_guest_should_see_login_link1 SKIPPED (unconditional skip)
# s3_lesson5_marks_Skipped.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page1
# start browser for test..
# PASSED
# quit browser..
#
# s3_lesson5_marks_Skipped.py::TestMainPage1::test_guest_should_see_login_link2
# start browser for test..
# PASSED
# quit browser..
#
# s3_lesson5_marks_Skipped.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page2
# start browser for test..
# PASSED
# quit browser..
#
