...
pytest -v -m "smoke and not beta_users" lesson5_step7!_ЗапускТестов.py
"""
...
#
# lesson5_step7!_ЗапускТестов.py::TestMainPage::test_guest_can_login XPASS                                                                                                     [ 25%]
# lesson5_step7!_ЗапускТестов.py::TestBasket::test_guest_can_go_to_payment_page SKIPPED (not implemented yet)                                                                  [ 50%]
# lesson5_step7!_ЗапускТестов.py::TestBasket::test_guest_can_see_total_price PASSED                                                                                            [ 75%]
# lesson5_step7!_ЗапускТестов.py::TestBookPage::test_guest_can_add_book_to_basket SKIPPED (unconditional skip)                                                                 [100%]
#
