...
# collected 3 items
#
# lesson5_marks_XFail_1.py::TestMainPage1::test_guest_should_see_login_link PASSED                                                                               [ 33%]
# lesson5_marks_XFail_1.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page PASSED                                                             [ 66%]
# lesson5_marks_XFail_1.py::TestMainPage1::test_guest_should_see_search_button_on_the_main_page XFAIL                                                            [100%]
#
