...
# svitlana@svitlana-HP-ProBook-455-G1:~/PyTest/environments/selenium_course/session3/lesson4$ pytest -s -v test_fixture1_2.py
# ======================================= test session starts ===============================================
...
# collected 4 items
#
# test_fixture1_2.py::TestMainPage2::test_guest_should_see_login_link1
# start browser for test..
# PASSED
# quit browser for test..
#
# test_fixture1_2.py::TestMainPage2::test_guest_should_see_basket_link_on_the_main_page1
# start browser for test..
# PASSED
# quit browser for test..
#
# test_fixture1_2.py::TestMainPage2::test_guest_should_see_login_link2
# start browser for test..
# PASSED
# quit browser for test..
#
# test_fixture1_2.py::TestMainPage2::test_guest_should_see_basket_link_on_the_main_page2
# start browser for test..
# PASSED
# quit browser for test..
#
