...
Сохраните следующий код в файл test_fixture1_1.py  и запустите его с помощью PyTest.
Не забудьте указать параметр -s, чтобы увидеть текст, который выводится командой print().

pytest -s -v test_fixture1_1.py   (создание экземпляра браузера и его закрытие только один раз для всех тестов первого тест-сьюта)
pytest -s -v test_fixture1_2.py   (создание экземпляра браузера и его закрытие для каждого теста)


# pytest -s test_fixture1_1.py   (создание экземпляра браузера и его закрытие только один раз для всех тестов первого тест-сьюта)
...
# test_fixture1_2.py: (создание экземпляра браузера и его закрытие для каждого теста)
class TestMainPage2():
...
В консоли видим:
session3_lesson4_step2_fixture1.png
