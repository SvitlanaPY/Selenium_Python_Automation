...
# svitlana@svitlana-HP-ProBook-455-G1:~/PyTest/environments/selenium_course/session3/lesson4$ pytest -s -v s3_lesson4_step2_fixture1_1.py
# ============================================== test session starts ============================================
...
# collected 4 items
#
# s3_lesson4_step2_fixture1_1.py::TestMainPage1::test_guest_should_see_login_link
# start browser for test suite..
# PASSED
# s3_lesson4_step2_fixture1_1.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page PASSED
# s3_lesson4_step2_fixture1_1.py::TestMainPage1::test_guest_should_see_login_link2 PASSED
# s3_lesson4_step2_fixture1_1.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page2 PASSED
