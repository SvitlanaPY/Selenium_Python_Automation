...
# $ pytest -s -v s3_lesson4_step5_fixture1_5_scope_function.py
...
# collected 4 items
#
# s3_lesson4_step5_fixture1_5_scope_function.py::TestMainPage1::test_guest_should_see_login_link1
# start browser for test..
# start test1
# finish test1
# PASSED
# quit browser..
#
# s3_lesson4_step5_fixture1_5_scope_function.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page1
# start browser for test..
# start test2
# finish test2
# PASSED
# quit browser..
#
# s3_lesson4_step5_fixture1_5_scope_function.py::TestMainPage1::test_guest_should_see_login_link2
# start browser for test..
# start test3
# finish test3
# PASSED
# quit browser..
#
# s3_lesson4_step5_fixture1_5_scope_function.py::TestMainPage1::test_guest_should_see_basket_link_on_the_main_page2
# start browser for test..
# start test4
# finish test4
# PASSED
