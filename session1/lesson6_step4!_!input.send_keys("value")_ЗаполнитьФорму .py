...
Создайте файл lesson6_step4!_!input.send_keys("value")_ЗаполнитьФорму .py (обратите внимание на расширение .py) и вставьте туда шаблон кода.
Подберите селекторы и запустите из командной строки, так же, как в уроке 2:

python lesson6_step4!_!input.send_keys("value")_ЗаполнитьФорму .py
